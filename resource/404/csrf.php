...
<head>
  <meta charset="utf-8">
    ...
    <title>403 Page not allowed </title>
		  ...
		  <div class="row h-p100 align-items-center justify-content-center text-center">
			  <div class="col-lg-7 col-md-10 col-12">
				  <div class="b-double border-gray rounded">
					  ...
					  <h1>Page kan !</h1>
					  <h3>Waxaad soo gashay meel qaldan fadlan submit ka badan dhaaf ee ku laabo home ka plase fadlan submit ka hal mar kabadan ha riixin waa codsi mahad sanid</h3>
...
<?php }
$body->write(error($csrf));
return $response->withStatus(400)->withHeader('Content-type', 'text/html')->withBody($body);
